...
def data_gathering(link):
    ...
    #print(profile['src'])
    if profile.attrs.get('src') is not None:
        dp = profile['src']
    else:
        dp = 'https://www.gstatic.com/images/branding/product/2x/avatar_anonymous_512dp.png'
